...
public class RawIssueMatch {
    ...
    public static void main(String[] args) throws IOException {
        ...
        preRawIssue1.setFileName("src/main/resources/testFile/commit1/MatchFailed.java");
        ...
        preRawIssue2.setFileName("src/main/resources/testFile/commit1/MatchFailed.java");
        ...
        curRawIssue1.setFileName("src/main/resources/testFile/commit2/MatchFailed2.java");
        ...
        curRawIssue2.setFileName("src/main/resources/testFile/commit2/MatchFailed2.java");
